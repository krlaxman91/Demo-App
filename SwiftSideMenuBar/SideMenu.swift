...
public extension UIViewController {
    ...
    */
    func fixSideMenuSize() {
        if let navController = self.navigationController as? SideMenuNavigationControllerViewController {
...
public class SideMenu: NSObject , UIGestureRecognizerDelegate {
